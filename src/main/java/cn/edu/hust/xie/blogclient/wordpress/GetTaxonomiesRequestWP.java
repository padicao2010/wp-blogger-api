 ...
 * @author padicao
 */
public class GetTaxonomiesRequestWP extends Request {

    private static final String METHOD_NAME = "wp.getTaxonomies";
    
    public GetTaxonomiesRequestWP(BlogCore c) {
        super(METHOD_NAME);
    ...
    public Response getResponseInstance() {
        return new GetTaxonomiesResponseWP();
    }
