 ...
 * @author padicao
 */
public class EditPostRequestWP extends Request {

    private static final String METHOD_NAME = "wp.editPost";
    
    public EditPostRequestWP(BlogCore c, PostInfo p) {
        super(METHOD_NAME);
        ...
        params[4] = new RequestParam(XMLTags.STRUCT, map);
    }
    
    @Override
    public Response getResponseInstance() {
        return new EditPostResponseWP();
    }
